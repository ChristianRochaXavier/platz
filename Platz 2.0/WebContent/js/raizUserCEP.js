$(document).ready(
		...
		function() {
			...
			// Variáveis
			var txtCep = $("#form-usuario\\:txtCepUser");
			var rua = $("#input_form-usuario\\:txtRuaUser");
			var bairro = $("#input_form-usuario\\:txtBairroUser");
			var cidade = $("#input_form-usuario\\:txtCidadeUser");
			var estado = $("#input_form-usuario\\:txtEstadoUser");
